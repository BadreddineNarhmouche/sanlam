...
{
    public class NotificationTypeCommandRepository : CommandRepository<NotificationType>, INotificationTypeCommandRepository
    {
        #region Constructors

        public NotificationTypeCommandRepository(ApplicationContext context) : base(context)
        {
        }
