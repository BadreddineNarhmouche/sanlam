...
import {
  type FilterCriteriaQuittances,
  type TreatSubscriptionQuittanceItem,
  type ValidateSubscriptionQuittanceItem,
  type FilterCriteriaNotifications,
  type Notification,
  type FilterCriteriaPayments,
...
export interface IQuittanceDetailsService {
  ...
  downloadQuittanceDocumentById?: (payload: { id: string }) => void;
  getQuittanceDocumentById?: (payload: { id: string }) => void;
  ...
  getAllQuittanceDocumentsByCriteria?: (payload: { quittanceId: any }) => void;
...
export interface IDeliverySlipDetailsService {
  ...
  downloadDeliverySlipDocumentById?: (payload: { id: string }) => void;
  getDeliverySlipDocumentById?: (payload: { id: string }) => void;
...
export interface IPaymentService {
  ...
  downloadPaymentDocumentById?: (payload: { id: string }) => void;
  getPaymentDocumentById?: (payload: { id: string }) => void;
  ...
  getAllPaymentDocumentsByCriteria?: (payload: { paymentId: any }) => void;
}
