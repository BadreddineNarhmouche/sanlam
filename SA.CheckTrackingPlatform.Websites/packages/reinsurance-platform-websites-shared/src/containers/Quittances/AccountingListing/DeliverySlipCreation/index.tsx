...
import {
  ACCOUNTING_QUITTANCELINE_DELIVERYSLIP_CREATION_COLUMNS_DEFAULT,
  ACCOUNTING_DELIVERYSLIP_CREATION_TABLE_HIDDEN_COLUMNS_DEFAULT,
} from "../../constants";
...
export const DeliverySlipCreation = ({
  ...
  return (
    <Dialog
      ...
      title={<FormattedMessage id="payment_creation_virement_dialog_title" />}
      content={
        <>
          <Typography variant="body2">
            <FormattedMessage
              id="payment_creation_virement_dialog_message"
              values={{
