...
const isStringNullOrWhiteSpace = (value) => {
    return (value === undefined ||
        value === null ||
        value.trim() === GeneralConstants.empty);
};
const isObjectNull = (value) => {
    return value === undefined || value === null;
};
const isObjectNotNull = (value) => {
    return !isObjectNull(value);
};
const isStringNullOrEmpty = (value) => {
    return (value === undefined || value === null || value === GeneralConstants.empty);
};
...
const buildFullNameAbbreviation = (firstName, lastName) => {
    return ((isStringNullOrWhiteSpace(firstName)
        ? GeneralConstants.empty
        : firstName.charAt(0)) +
        (isStringNullOrWhiteSpace(lastName)
...
const buildOrganizationNameCode = (organizationName, code) => {
...
const filterObjectByTemplate = (obj, template) => {
    const result = {};
...
const filterDataByKeys = (dataArray, keys) => {
...
const isFileSizeValid = (fileSize, minimumLengthInBytes, maximumLengthInBytes) => {
